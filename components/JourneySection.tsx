      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
            ...
            <Reveal className="lg:col-span-8" delay={0}>
              <div
                ...
                className="relative h-[320px] sm:h-[380px] lg:h-[420px] rounded-3xl overflow-hidden cursor-pointer group shadow-sm hover:shadow-2xl active:scale-[0.99] transition-shadow duration-300"
              >
              <Image
            ...
            <Reveal className="lg:col-span-4" delay={120}>
              <div
                ...
                className="relative h-[280px] sm:h-[340px] lg:h-[420px] rounded-3xl overflow-hidden cursor-pointer group shadow-sm hover:shadow-2xl active:scale-[0.99] transition-shadow duration-300"
              >
                <Image
                  src={jeepTour.image}
                  alt={jeepTour.title}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <Reveal className="sm:col-span-2 lg:col-span-1" delay={180}>
              <div
                id="tour-card-horse"
